...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/catalog/product": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_user_service.ProductUpdateStruct"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                "description": "Cria um produto no catálogo do WhatsApp Business da instância.\nForneça a imagem via ` + "`" + `imageBase64` + "`" + ` (recomendado) ou ` + "`" + `imageUrl` + "`" + `.\n` + "`" + `price` + "`" + ` é em miliunidades da moeda (R$ 10,00 = 10000).",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_user_service.ProductCreateStruct"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_user_service.ProductDeleteStruct"
                        }
                    }
                ],
                "responses": {
        ...
        "/send/product": {
            "post": {
                "description": "Envia o card de um produto do catálogo (foto, título, preço e botão)\npara um contato. Os produtos são criados no app oficial / Meta Commerce\nManager; aqui você informa o ` + "`" + `productId` + "`" + ` e os dados exibidos no card.\n` + "`" + `price` + "`" + ` é em miliunidades da moeda (R$ 10,00 = 10000).",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "github_com_evolution-foundation_evolution-go_pkg_sendMessage_service.ProductStruct": {
            ...
            "properties": {
                ...
                "businessOwnerJid": {
                    "description": "JID do dono do catálogo. Se vazio, usa o JID da própria instância.",
                    "type": "string"
                },
                "currency": {
                    "type": "string",
                ...
                "imageBase64": {
                    "description": "Imagem do produto: base64 ou URL externa (será baixada e reenviada).",
                    "type": "string"
                },
                "imageUrl": {
                    "type": "string"
                ...
                "price": {
                    "description": "Preço em miliunidades da moeda: R$ 10,00 =\u003e 10000.",
                    "type": "integer"
                },
                "productId": {
                    "description": "Dados do produto (aparecem no card). O ProductId deve ser o ID do produto\nno seu catálogo — pegue no app oficial / Commerce Manager.",
                    "type": "string"
                },
                "quoted": {
                    "$ref": "#/definitions/github_com_evolution-foundation_evolution-go_pkg_sendMessage_service.QuotedStruct"
        ...
        "github_com_evolution-foundation_evolution-go_pkg_user_service.ProductCreateStruct": {
            "type": "object",
            "properties": {
                "currency": {
                    "type": "string",
                ...
                "imageBase64": {
                    "description": "Forneça UMA das opções de imagem:",
                    "type": "string"
                },
                "imageUrl": {
                    "description": "URL externa (será baixada) ou uma URL .whatsapp.net (reusada)",
                    "type": "string"
                },
                "isHidden": {
                    "type": "boolean"
                ...
                "name": {
                    "type": "string",
                    "example": "Camiseta Athene"
                },
                "originCountryCode": {
                    "description": "País de origem (ISO 3166-1 alpha-2, ex.: \"BR\"). O WhatsApp passou a exigir\nesse campo no cadastro de produto. Se vazio, envia COUNTRY_ORIGIN_EXEMPT\n(comportamento antigo do Baileys), que tende a ser rejeitado.",
                    "type": "string",
                    "example": "BR"
                },
                "price": {
                    "description": "Preço em miliunidades da moeda: R$ 10,00 =\u003e 10000. (padrão do WhatsApp)",
                    "type": "integer",
                    "example": 10000
                },
                "retailerId": {
        ...
        "github_com_evolution-foundation_evolution-go_pkg_user_service.ProductDeleteStruct": {
            "type": "object",
            "properties": {
                "productIds": {
                    "type": "array",
        ...
        "github_com_evolution-foundation_evolution-go_pkg_user_service.ProductUpdateStruct": {
            "type": "object",
            "properties": {
                "currency": {
                    "type": "string"
                ...
                "originCountryCode": {
                    "description": "País de origem (ISO 3166-1 alpha-2, ex.: \"BR\").",
                    "type": "string",
                    "example": "BR"
                },
                "price": {
