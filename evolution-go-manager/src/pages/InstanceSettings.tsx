...
import { TypebotSettings } from "@/components/instances";
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {/* Typebot — fora do <form> acima porque tem submit próprio, e as
              rotas /typebot usam o token da instância, não a apikey global. */}
          {instance?.apikey && <TypebotSettings instanceToken={instance.apikey} />}
