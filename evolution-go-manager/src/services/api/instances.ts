...
export const getQrCode = async (
  ...
  // A API responde { data: { qrcode, code } } em minúsculas. Este código lia
  // data.Qrcode/data.Code capitalizados: como a anotação de tipo do axios não é
  // validada em runtime, os campos vinham undefined sem erro nenhum e o modal
  // abria com o QR em branco.
  //
  // As duas grafias são aceitas para tolerar respostas antigas de instalações
